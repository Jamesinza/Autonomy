...
class PlasticityModelMoE(tf.keras.Model):
    def __init__(self, h, w, plasticity_controller, num_experts=2, max_units=128, initial_units=32, num_classes=10, **kwargs):
        ...
        self.unsupervised_extractor.load_weights('model_weights/unsupervised_extractor_v3c/model.weights.h5')
        self.flatten = tf.keras.layers.Flatten()
        ...
        if current_val_loss < best_val_loss - early_stop_min_delta:
            ...
            if patience_counter >= early_stop_patience:
                ...
                if best_weights is not None:
                    ...
                    model.save("models/MetaSynapse_NextGen_v3d_tuning.keras")
                    model.unsupervised_extractor.save("models/unsupervised_extractor_v3d_tuning.keras")
                    patience_counter = 0
